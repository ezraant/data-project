#this is the linear regression one
import pandas as pd
...
#  STEP 1: LOAD DATA (happend once in beginning)
...
# STEP 2: DEFINE THE FUNCTION (using linear regression)
...
def predict_player(player_name, stat, line):
    ...
    #mkae rollling average features
